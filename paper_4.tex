...
\begin{figure*}[t!]
    \centering
    \includegraphics[scale=0.52,viewport=0 30 980 500,clip=true]{./sources/ran.eps}
    \vspace{-10pt}
...
\begin{table*}[htbp]
    ...
    \begin{tabular}{@{}c|c|cccc|cc|c|c|c@{}}
        \toprule
        \multirow{3}{*}{\textbf{Dataset}} & \multirow{3}{*}{\textbf{metrics}} & \multicolumn{4}{c|}{\multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Shallow \\ Model\end{tabular}}}} & \multicolumn{2}{c|}{\multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Neural Network \\ Based Model\end{tabular}}}} & \multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Attention \\ Based Model\end{tabular}}} & \multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Our\\ Model\end{tabular}}} & \multirow{3}{*}{\textbf{Improve}} \\
