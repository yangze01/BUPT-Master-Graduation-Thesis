...
% \begin{figure*}[htbp]
%     \centering
%     \includegraphics[scale=0.4, clip=true]{./sources/rel_example.eps}
%     \vspace{-10pt}
...
\begin{figure*}[htb]
    \centering
    \includegraphics[width=12cm,height=6cm, clip=true]{./sources/rel_fasttext.eps}
    \vspace{-10pt}
...
\begin{figure*}[htb]
    \centering
    \includegraphics[width=12cm,height=5cm,clip=true]{./sources/rel_lstm.eps}
    \vspace{-10pt}
