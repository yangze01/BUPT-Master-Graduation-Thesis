...
\includegraphics[scale=0.48,viewport=0 0 450 350,clip=true]{./sources/1.eps}
...
\begin{figure*}[htb]
\centering
\includegraphics[scale=0.48,clip=true]{./sources/2.eps}
...
\begin{figure*}[htb]
\centering
\includegraphics[scale=0.48,viewport=0 30 980 500,clip=true]{./sources/DPAM.eps}
\vspace{-10pt}
...
\caption{\label{fig:comMain}诈骗案由数据集DPAM与基线模型实验对比图}
\end{figure*}
